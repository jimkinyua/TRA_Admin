...
<form>
	<fieldset>
	  <legend>Add/Edit <?php echo $FormName; ?> Columns</legend>
			  ...
			  <td><label>Form</label>
                    <div class="input-control select" data-role="input-control">
                    	...
                    	<select name="FormID"  id="FormID">
                            ...
                            <?php 
							if ($FormID==''){
                            	$s_sql = "SELECT * FROM LicenenceRenewalForm ORDER BY FormID";
							}else{
								$s_sql = "SELECT * FROM LicenenceRenewalForm where FormID=$FormID";
							}
			  ...
			  <td><label>Form Section</label>
                    <div class="input-control select" data-role="input-control">
                    	...
                    	<select name="FormSectionID"  id="FormSectionID">
                            <option value="0" selected="selected"></option>
                            <?php 
                            $s_sql = "SELECT * FROM LicenceRenewalFormSection where LicenceRenewalFormID=$FormID ORDER BY 1";
			  ...
			  <td><label>Filter Column</label>
                    <div class="input-control select" data-role="input-control">
                    	...
                    	<select name="FilterColumnID"  id="FilterColumnID">
                            <option value="0" selected="selected"></option>
                            <?php 
                            $s_sql = "SELECT * FROM LicenceRenewalColumns where LicenceRenewalFormID=$FormID ORDER BY 1";
                            // echo ($s_sql);
                            // exit;
                            $s_result = sqlsrv_query($db, $s_sql);
                            if ($s_result) 
		...
		<input name="Button" type="button" onclick="loadmypage('licence_renewal_form_columns_list.php?'+
                                                    ...
                                                    '&save=1','content','loader','listpages','','LicenceRenewalFormColumns','<?php echo $FormID; ?>')" value="Save">
