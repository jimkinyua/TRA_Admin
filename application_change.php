   ...
   <form>
      <fieldset>
          <table width="100%" border="0" cellspacing="0" cellpadding="3">
			...
			<tr>
                  <td width="50%">
					  <label>Chage Service To..</label>
						  <div class="input-control select" data-role="input-control">
							<select name="ToServiceID"  id="ToServiceID">
							<option value="0" selected="selected"></option>
							<?php 
							$s_sql = "select ServiceID, convert(nvarchar(50),isnull(ServiceCode,''))+' '+ServiceName ServiceName 
									from Services 
									order by convert(int,ServiceCode)";
			...
			<tr>
                  <td width="50%">
					  <label>Chage Sub System To..</label>
						  <div class="input-control select" data-role="input-control">
		...
		<input type="button" value="Change" onClick="deleteConfirm2('Are you sure you want to change the service','service_approval.php?change=1&ApplicationID=<?php echo $ApplicationID; ?>&CurrentStatus=<?php echo $CurrentStatus; ?>&FromServiceID=<?php echo $ServiceID; ?>&ToServiceID='+this.form.ToServiceID.value+'&FromSubSystemID=<?php echo $SubSystemID; ?>&ToSubSystemID='+this.form.ToSubSystemID.value+'&FromWardID=<?php echo $WardID; ?>&ToWardID='+this.form.ToWardID.value+'&Notes='+this.form.Notes.value+'','content','loader','listpages','','applications','<?php echo $_SESSION['RoleCenter'] ?>')"> 		  
