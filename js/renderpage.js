...
// loadmypage('invoices_list.php?i=1','content','loader','listpages','','invoices-a')

function renderpage(url,destination,loader,op,id,opv,exPM) {
  loadmypage(url,destination,loader,op,id,opv,exPM)
