						...
						<table width="100%">
								<tr>
									...
									<td>
										...
										<input name="btnSearch" type="button" onclick="loadmypage('land_billing.php?'+
										'&upn='+this.form.upn.value+
										'&plotno='+this.form.plotno.value+
										'&lrno='+this.form.lrno.value+
										'&ownernames='+this.form.ownernames.value+
										'&FirmID='+this.form.FirmID.value+'&search=1','content','loader','listpages','','Land','upn='+this.form.upn.value+':plotno='+this.form.plotno.value+':lrn='+this.form.lrno.value+':owner='+this.form.ownernames.value+':firmid='+this.form.FirmID.value+':idno='+this.form.idno.value+'','<?php echo $_SESSION['UserID']; ?>')" value="Search">					
									</td>
