						...
						{								
							...
							if ($rs)
							{
								...
								{									
									...
									$s_sql="set dateformat dmy insert into InvoiceLines ggg(InvoiceHeaderID,ServiceHeaderID,ServiceID,Amount,CreatedBy) 
											Values($InvoiceHeader,$ApplicationID,$ServiceID,$ServiceAmount,$UserID)";
...
?>
	...
	<script type="text/javascript">
        ...
        <div class="example">
        <legend>Licence Applications</legend> || <legend>Issued Licences</legend>
