...
<body class="metro">
	<div class="example">
		<legend>Bus Perks (Saccos)</legend>        
		<table class="table striped hovered dataTable" id="dataTables-1">
			...
			<tr>
				<th width="14%" class="text-left">CustomerID</th>
				<th width="12%" class="text-left">Company Name</th>
				<th width="20%" class="text-left">No Of Vevicles</th>
