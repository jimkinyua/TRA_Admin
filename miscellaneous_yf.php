	...
	<fieldset>
	  <legend>Micelleneous Charges</legend>
		<table width="100%" border="0" cellspacing="0" cellpadding="3">
          ...
          <tr>
			  <td><label>Yellow Fever</label>
				<div class="input-control select" data-role="input-control">
					<select name="yellow_ServiceID"  id="yellow_ServiceID">
					<option value="0" selected="selected"></option>
					<?php 
					$s_sql = "SELECT * FROM Services where ServiceID='2752' ORDER BY ServiceName";
                  ...
                  <td>
					<label>Amount</label>
					<div class="input-control text" data-role="input-control">
						<input type="text" id="yellow_Amount" name="yellow_Amount" value="<?php echo $yellow_Amount; ?>" style="width: 100px; text-align:right"></input>
						<button class="btn-clear" tabindex="-1"></button>
					</div>				  
                  </td>
          </tr>
          <tr>
			  <td><label>Booklet Fee</label>
				<div class="input-control select" data-role="input-control">
					<select name="booklet_ServiceID"  id="booklet_ServiceID">
					<option value="0" selected="selected"></option>
					<?php 
					$s_sql = "SELECT * FROM Services where ServiceID='2760' ORDER BY ServiceName";
                  ...
                  <td>
					<label>Amount</label>
					<div class="input-control text" data-role="input-control">
						<input type="text" id="booklet_Amount" name="booklet_Amount" value="<?php echo $booklet_Amount; ?>" style="width: 100px; text-align:right"></input>
						<button class="btn-clear" tabindex="-1"></button>
					</div>				  
                  </td>
          </tr>
          <tr>
			  <td><label>Stamp</label>
				<div class="input-control select" data-role="input-control">
					<select name="stamp_ServiceID"  id="stamp_ServiceID">
					<?php 
					$s_sql = "SELECT * FROM Services where ServiceID='896' ORDER BY ServiceName";
                  ...
                  <td>
					<label>Amount</label>
					<div class="input-control text" data-role="input-control">
						<input type="text" id="stamp_Amount" name="stamp_Amount" value="<?php echo $stamp_Amount; ?>" style="width: 100px; text-align:right"></input>
						<button class="btn-clear" tabindex="-1"></button>
					</div>				  
                  </td>
          </tr>
		...
		<input name="Button" type="button" onclick="loadmypage('miscellaneous_list.php?'+
                                            ...
                                            '&booklet_Amount='+this.form.booklet_Amount.value+ 
											'&stamp_Amount='+this.form.stamp_Amount.value+ 
											'&yellow_Amount='+this.form.yellow_Amount.value+ 
											'&Os_Amount='+this.form.Os_Amount.value+ 
                                            '&Description='+this.form.Description.value+ 
											'&booklet_ServiceID='+this.form.booklet_ServiceID.value+
											'&stamp_ServiceID='+this.form.stamp_ServiceID.value+
											'&yellow_ServiceID='+this.form.yellow_ServiceID.value+
