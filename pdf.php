...
require("phpToPDF\sendToEmail.php");
...
//tuma Invoice	
$my_file = "pdf_invoice.pdf";
$my_path = "phpToPDF/";
$my_name = "County Govt";
$my_mail = "cngeno11@gmail.com";
$my_replyto = "cngeno11@gmail.com";
$my_subject = "This mail is sent from the portal.";
$my_message="Message";
//$my_message = "Hallo,\r\Kindly Receive your Invoice.\r\n\r\ngr. County";

mail_attachment($my_file, $my_path, "cngeno11@gmail.com", $my_mail, $my_name, $my_replyto, $my_subject, $my_message);	
