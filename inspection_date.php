...
<input type="button" value="Save Date" onClick="deleteConfirm2('Are you sure you want to save the date','LicenceAppliactionApprovedByOfficerCard.php?InspectionDate=1&ApplicationID=<?php echo $ApplicationID; ?>&CurrentStatus=<?php echo $CurrentStatus; ?>&SetDate='+this.form.SetDate.value+'','content','loader','listpages','','applications','<?php echo $_SESSION['RoleCenter'] ?>')"> 
