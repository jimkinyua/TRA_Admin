...
<form>
	<fieldset>
	  <legend>Add/Edit <?php echo $FormName; ?> Sections</legend>
		...
		<input name="Button" type="button" onclick="loadmypage('licence_renewal_form_sections_list.php?'+
        											'&FormSectionName='+this.form.FormSectionName.value+
                                                    '&FormID='+this.form.FormID.value+
                                                    '&FormSectionID='+<?php echo $FormSectionID; ?>+
                                                    '&save=1','content','loader','listpages','','LicenceRenewalFormSections','<?php echo $FormID; ?>')" value="Save">
                                                    
      <input type="reset" value="Cancel" onClick="loadmypage('licence_renewal_form_sections_list.php?FormID=<?php echo $FormID; ?>&FormName=<?php echo $FormName; ?>','content','loader','listpages','','LicenceRenewalFormSections','<?php echo $FormID; ?>')">
